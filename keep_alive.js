...
app.get('/watch', async (req, res) => {
	try {
		...
		const response = await axios.get('https://replit.com/@Stanlxy/Yoru-Pack', { headers });
		// Check the response
...
app.get('/like', async (req, res) => {
	try {
		...
		const response = await axios.post('https://replit.com/like/@Stanlxy/Yoru-Pack', {}, { headers });
